const MyChannelSlaider = new Swiper('.MyChannelSlaider', {
  // Optional parameters
  loop: true,
  slidesPerView: 1,
  spaceBetween: 20,
...
const RecommendedChannel = new Swiper('.Recommended-channel', {
  // Optional parameters
  loop: true,
  slidesPerView: 1,
  spaceBetween: 20,
...
if (document.documentElement.scrollWidth <= 640) {
  MyChannelSlaider.destroy();
  RecommendedSlider.destroy();
RecommendedChannel.destroy();
